...
#     OUTDIR       - Output directory for generated .tml.cc and .tml.h files (required)
#
#   LIST_ARGS:
...
# OutputVariable:
#     ${NAME}_SRCS  - list of *tml.cc
#     ${NAME}_HRDS  - list of *tml.h
#
# Behavior:
...
#       - Determines output .tml.cc and .tml.h filenames.
#       - Adds a custom command to generate C++ files using protoc.
#   5. Collects all generated .tml.cc and .tml.h files into HDRS and SRCS lists.
...
function(kmcmake_cc_tml)
    ...
    foreach (P ${KMCMAKE_CC_PROTO_PROTOS})
        ...
        set(HDR ${PROTO_DIR}/${PROTO_NAME_WE}.tml.h)
        set(SRC ${PROTO_DIR}/${PROTO_NAME_WE}.tml.cc)
        list(APPEND HDRS ${HDR})
        list(APPEND SRCS ${SRC})

        message(STATUS "${PROTOBUF_PROTOC_EXECUTABLE} ${PROTOC_FLAGS} ${INCLUDE_FLAGS} --plugin=protoc-gen-tml=${SHARK_TML_EXEC_FILE} --tml_out=${KMCMAKE_CC_PROTO_OUTDIR} ${PROTO_ABS}")
        add_custom_command(
                OUTPUT ${HDR} ${SRC}
                COMMAND ${PROTOBUF_PROTOC_EXECUTABLE} ${PROTOC_FLAGS} ${INCLUDE_FLAGS} --plugin=protoc-gen-tml=${SHARK_TML_EXEC_FILE} --tml_out=${KMCMAKE_CC_PROTO_OUTDIR} ${PROTO_ABS}
