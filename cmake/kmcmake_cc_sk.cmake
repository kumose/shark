...
#     OUTDIR       - Output directory for generated .sk.cc and .sk.h files (required)
#
#   LIST_ARGS:
...
# OutputVariable:
#     ${NAME}_SRCS  - list of *sk.cc
#     ${NAME}_HRDS  - list of *sk.h
#
# Behavior:
...
#       - Determines output .sk.cc and .sk.h filenames.
#       - Adds a custom command to generate C++ files using protoc.
#   5. Collects all generated .sk.cc and .sk.h files into HDRS and SRCS lists.
...
function(kmcmake_cc_sk)
    ...
    foreach (P ${KMCMAKE_CC_PROTO_PROTOS})
        ...
        set(HDR ${PROTO_DIR}/${PROTO_NAME_WE}.sk.h)
        set(SRC ${PROTO_DIR}/${PROTO_NAME_WE}.sk.cc)
