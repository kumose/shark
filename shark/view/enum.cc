...
namespace shark {
    ...
    EnumViewGenerator::~EnumViewGenerator() {
    }

    void EnumViewGenerator::generate_definition(google::protobuf::io::Printer *printer, const google::protobuf::Descriptor* parent) {
        if (!parent) {
            return;
        }
    ...
    void EnumViewGenerator::generate_inline_declarations(google::protobuf::io::Printer* printer,
                                                 const google::protobuf::Descriptor* parent) {
    }

    void EnumViewGenerator::generate_inline_definition(google::protobuf::io::Printer* printer,
                                               const google::protobuf::Descriptor* parent) {
    }
