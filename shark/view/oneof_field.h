...
namespace shark {
    class OneofFieldViewGenerator {
    public:
        explicit OneofFieldViewGenerator(const google::protobuf::Descriptor *mdes) : mdes_(mdes), msg_(message_domain_without_namespace(mdes_,  "View") ) {
        }

        ~OneofFieldViewGenerator();
    ...
    private:
        std::string get_field_view(const google::protobuf::FieldDescriptor *field) const;
