...
namespace shark {
    ServiceViewGenerator::ServiceViewGenerator(const google::protobuf::ServiceDescriptor *descriptor,
    ...
    ServiceViewGenerator::~ServiceViewGenerator() {
    }

    // Header stuff.
    void ServiceViewGenerator::GenerateMainHFile(google::protobuf::io::Printer *printer) {
        GenerateVfuncs(printer);
        GenerateInitMacros(printer);
        GenerateCallersDeclarations(printer);
    }

    void ServiceViewGenerator::GenerateVfuncs(google::protobuf::io::Printer *printer) {
        printer->Print(vars_,
    ...
    void ServiceViewGenerator::GenerateInitMacros(google::protobuf::io::Printer *printer) {
        printer->Print(vars_,
    ...
    void ServiceViewGenerator::GenerateCallersDeclarations(google::protobuf::io::Printer *printer) {
        for (int i = 0; i < descriptor_->method_count(); i++) {
            const google::protobuf::MethodDescriptor *method = descriptor_->method(i);
            std::string lcname = CamelToLower(method->name());
    ...
    void ServiceViewGenerator::GenerateDescriptorDeclarations(google::protobuf::io::Printer *printer) {
        printer->Print(vars_, "extern const ProtobufCServiceDescriptor $lcfullname$__descriptor;\n");
    }


    // Source file stuff.
    void ServiceViewGenerator::GenerateCFile(google::protobuf::io::Printer *printer) {
        GenerateServiceDescriptor(printer);
        GenerateCallersImplementations(printer);
        GenerateInit(printer);
    }

    void ServiceViewGenerator::GenerateInit(google::protobuf::io::Printer *printer) {
        printer->Print(vars_,
                       "void $lcfullname$__init ($cname$_Service *service,\n"
                       "     $lcfullpadd$        $cname$_ServiceDestroy destroy)\n"
                       "{\n"
    ...
    void ServiceViewGenerator::GenerateServiceDescriptor(google::protobuf::io::Printer *printer) {
    ...
    void ServiceViewGenerator::GenerateCallersImplementations(google::protobuf::io::Printer *printer) {
        for (int i = 0; i < descriptor_->method_count(); i++) {
            const google::protobuf::MethodDescriptor *method = descriptor_->method(i);
            std::string lcname = CamelToLower(method->name());
            std::string lcfullname = FullNameToLower(descriptor_->full_name(), descriptor_->file());
