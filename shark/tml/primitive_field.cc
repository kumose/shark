...
namespace shark {
    ...
    void PrimitiveFieldGenerator::generate_trans_parse_toml_implementations(
        ...
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
                ...
                printer->Print(_variables, "TURBO_MOVE_OR_RAISE(auto tmp, xtoml::find_key<$c_type$>(config, \"$name$\"));\n");
    ...
    void PrimitiveFieldGenerator::generate_trans_toml_implementations(google::protobuf::io::Printer *printer, bool required) const {
