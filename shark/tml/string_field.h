...
namespace shark {
    class StringFieldGenerator : public FieldNoMetaGenerator {
    public:
        ...
        void generate_trans_toml_implementations(google::protobuf::io::Printer *printer, bool required= false) const override;
