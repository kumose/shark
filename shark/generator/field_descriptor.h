...
namespace shark {
    ...
    class FieldDescriptorGenerator : public FieldGeneratorBase {
    public:
        explicit FieldDescriptorGenerator(const google::protobuf::FieldDescriptor *descriptor, const FieldMetaMap *map,
                                          std::string path) : FieldGeneratorBase(descriptor), _path(path),
                                                       _field_meta_map(map) {
        }

        ~FieldDescriptorGenerator() override = default;
    ...
    protected:
        std::string _path;
        const FieldMetaMap *_field_meta_map{nullptr};
    };
} // namespace shark
