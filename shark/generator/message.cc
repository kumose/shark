...
namespace shark {
    MessageGenerator::MessageGenerator(const google::protobuf::Descriptor *descriptor,
        ...
        : _message(parent ? turbo::str_cat(parent->_message, "::", descriptor->name()) : descriptor->name()),
          descriptor_(descriptor),
          dllexport_decl_(dllexport_decl),
          field_generators_(descriptor, _message),
            _oneof_generator(descriptor_, _message){
        ...
        _vars["field_count"] = SimpleItoa(descriptor_->field_count());
