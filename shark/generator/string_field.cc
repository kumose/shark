...
namespace shark {
    ...
    StringFieldGenerator(const google::protobuf::FieldDescriptor *descriptor , std::string message)
    ...
    void StringFieldGenerator::generate_members_declares(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                printer->Print(variables_, "$deprecated$ inline const std::string& $name$() const;\n");
    ...
    void StringFieldGenerator::generate_members_inline_implementations(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            ...
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                ...
                printer->Print(variables_, "inline const std::string& $message$::$name$() const {\n");
                printer->Indent();
                printer->Print(variables_, "return _$name$;\n");
                printer->Outdent();
                printer->Print(variables_, "}\n");
                printer->Print(variables_, "/// setter\n");
                printer->Print(variables_, "inline void $message$::set_$name$(const std::string &v) {\n");
                printer->Indent();
            ...
            case google::protobuf::FieldDescriptor::LABEL_REPEATED:
                printer->Print(variables_, "/// getter\n");
                printer->Print(variables_, "inline const std::vector<std::string>& $message$::$name$() const {\n");
                printer->Indent();
                printer->Print(variables_, "return _$name$;\n");
                printer->Outdent();
                printer->Print(variables_, "}\n\n");
                printer->Print(variables_, "/// setter\n");
                printer->Print(variables_, "inline std::vector<std::string>& $message$::mutable_$name$() {\n");
                printer->Indent();
                printer->Print(variables_, "return _$name$;\n");
                printer->Outdent();
                printer->Print(variables_, "}\n\n");
