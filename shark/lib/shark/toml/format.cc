#include <shark/toml/fwd/format_fwd.h>
...
namespace shark {
    ...
    TOML11_INLINE_VERSION_NAMESPACE {
        ...
        // integer
         ...
         std::string to_string(const integer_format c) {
            std::ostringstream oss;
            oss << c;
            return oss.str();
        }
         ...
         bool operator==(const integer_format_info &lhs, const integer_format_info &rhs) noexcept {
        ...
        // floating
         ...
         std::string to_string(const floating_format c) {
            std::ostringstream oss;
            oss << c;
            return oss.str();
        }

         bool operator==(const floating_format_info &lhs, const floating_format_info &rhs) noexcept {
            return lhs.fmt == rhs.fmt &&
                   lhs.prec == rhs.prec &&
                   lhs.suffix == rhs.suffix;
        }
        ...
        // string
         ...
         std::string to_string(const string_format c) {
            std::ostringstream oss;
            oss << c;
            return oss.str();
        }

         bool operator==(const string_format_info &lhs, const string_format_info &rhs) noexcept {
            return lhs.fmt == rhs.fmt &&
        ...
        // datetime
         ...
         std::string to_string(const datetime_delimiter_kind c) {
            std::ostringstream oss;
            oss << c;
            return oss.str();
        }
         ...
         bool operator==(const local_datetime_format_info &lhs, const local_datetime_format_info &rhs) noexcept {
            return lhs.delimiter == rhs.delimiter &&
                   lhs.has_seconds == rhs.has_seconds &&
                   lhs.subsecond_precision == rhs.subsecond_precision;
        }
         ...
         bool operator!=(const local_date_format_info &lhs, const local_date_format_info &rhs) noexcept {
            return !(lhs == rhs);
        }

         bool operator==(const local_time_format_info &lhs, const local_time_format_info &rhs) noexcept {
        ...
        // array
         ...
         std::string to_string(const array_format c) {
            std::ostringstream oss;
            oss << c;
            return oss.str();
        }

         bool operator==(const array_format_info &lhs, const array_format_info &rhs) noexcept {
            return lhs.fmt == rhs.fmt &&
        ...
        // table
         ...
         std::string to_string(const table_format c) {
            std::ostringstream oss;
            oss << c;
            return oss.str();
        }

         bool operator==(const table_format_info &lhs, const table_format_info &rhs) noexcept {
            return lhs.fmt == rhs.fmt &&
                   lhs.indent_type == rhs.indent_type &&
                   lhs.body_indent == rhs.body_indent &&
