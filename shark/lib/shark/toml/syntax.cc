#include <shark/toml/fwd/syntax_fwd.h>
            ...
            namespace syntax {
                ...
                sequence const &utf8_3bytes(const spec &) {
                    static thread_local sequence cache(/*1~2 bytes = */either(
                                                                           sequence(character(0xE0),
                                                                               character_in_range(0xA0, 0xBF)),
                                                                           sequence(character_in_range(0xE1, 0xEC),
                                                                               character_in_range(0x80, 0xBF)),
                                                                           sequence(character(0xED),
                                                                               character_in_range(0x80, 0x9F)),
                ...
                sequence const &utf8_4bytes(const spec &) {
                    static thread_local sequence cache(/*1~2 bytes = */either(
                                                                           sequence(character(0xF0),
                                                                               character_in_range(0x90, 0xBF)),
                                                                           sequence(character_in_range(0xF1, 0xF3),
                                                                               character_in_range(0x80, 0xBF)),
                                                                           sequence(character(0xF4),
                                                                               character_in_range(0x80, 0x8F))
                                                                       ), character_in_range(0x80, 0xBF),
                                                                       character_in_range(0x80, 0xBF));
                ...
                repeat_at_least const &ws(const spec &sp) {
                ...
                either const &allowed_comment_char(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &comment(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &num_suffix(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &dec_int(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        const auto digit19 = []() {
                ...
                sequence const &hex_int(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                            literal("0x"),
                            hexdig(s),
                ...
                sequence const &oct_int(const spec &s) {
                ...
                sequence const &bin_int(const spec &s) {
                    static thread_local auto cache = make_cache([](const spec &) {
                        const auto digit01 = []() {
                ...
                either const &integer(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return either(
                            hex_int(s),
                            oct_int(s),
                ...
                sequence const &zero_prefixable_int(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                            digit(s),
                            repeat_at_least(0,
                ...
                sequence const &fractional_part(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                            character('.'),
                ...
                sequence const &exponent_part(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                            character_either("eE"),
                            maybe(character_either("+-")),
                ...
                sequence const &hex_floating(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        // C99 hexfloat (%a)
                ...
                either const &floating(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return either(
                            sequence(
                                dec_int(s),
                ...
                sequence const &local_date(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                ...
                sequence const &local_time(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                either const &time_offset(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return either(
                            character_either("zZ"),
                ...
                sequence const &full_time(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                character_either const &time_delim(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &) {
                ...
                sequence const &local_datetime(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &offset_datetime(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &escaped_x2(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &escaped_u4(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &escaped_U8(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &escaped(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                either const &basic_char(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &basic_string(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                            character('"'),
                ...
                sequence const &escaped_newline(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                ...
                sequence const &ml_basic_string(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                either const &literal_char(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return either(
                            character(0x09),
                ...
                sequence const &literal_string(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                            character('\''),
                ...
                sequence const &ml_literal_string(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                either const &string(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return either(
                            ml_basic_string(s),
                            ml_literal_string(s),
                ...
                non_ascii_key_char::non_ascii_key_char(const spec &s) noexcept {
                    assert(s.ext_allow_non_english_in_bare_keys);
                    (void) s; // for NDEBUG
                }

                std::uint32_t non_ascii_key_char::read_utf8(location &loc) const {
                ...
                region non_ascii_key_char::scan(location &loc) const {
                ...
                repeat_at_least const &unquoted_key(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                either const &quoted_key(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                either const &simple_key(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &dot_sep(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &dotted_key(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(
                            simple_key(s),
                ...
                sequence const &keyval_sep(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                        return sequence(ws(s), character('='), ws(s));
                    });
                    return cache.at(sp);
                ...
                sequence const &std_table(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
                ...
                sequence const &array_table(const spec &sp) {
                    static thread_local auto cache = make_cache([](const spec &s) {
