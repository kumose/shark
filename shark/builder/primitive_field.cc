...
#include <shark/builder/primitive_field.h>
...
namespace shark {
    ...
    PrimitiveFieldSkbGenerator::~PrimitiveFieldSkbGenerator() {
    }

    void PrimitiveFieldSkbGenerator::generate_members(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                if (is_atomic) {
                    printer->Print(_variables, "std::atomic<$c_type$> _$name$$default_init$;\n");
                } else {
                    printer->Print(_variables, "$c_type$ _$name$$default_init$;\n");
                }

                break;
            case google::protobuf::FieldDescriptor::LABEL_REPEATED:
                printer->Print(_variables, "std::vector<$c_type$> _$name$;\n");
                break;
        }
    }

    void PrimitiveFieldSkbGenerator::generate_members_declares(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                printer->Print(_variables, "$deprecated$inline $c_type$ $name$() const;\n");
                printer->Print(_variables, "$deprecated$inline void $name$($c_type$ value);\n");
                break;
            case google::protobuf::FieldDescriptor::LABEL_REPEATED:
                printer->Print(_variables, "$deprecated$inline const std::vector<$c_type$>& $name$() const;\n");
                printer->Print(_variables, "$deprecated$inline std::vector<$c_type$>& mutable_$name$();\n");
                break;
        }
    }

    void PrimitiveFieldSkbGenerator::generate_members_inline_implementations(
        google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                printer->Print(_variables, "inline $c_type$ $domain_skb$::$name$$deprecated$() const {\n");
                printer->Indent();
                if (is_atomic) {
                ...
                printer->Print(_variables, "inline void $domain_skb$::$name$$deprecated$($c_type$ value) {\n");
                printer->Indent();
                if (is_atomic) {
            ...
            case google::protobuf::FieldDescriptor::LABEL_REPEATED:
                printer->Print(
                    _variables, "inline const std::vector<$c_type$>& $domain_skb$::$name$$deprecated$() const {\n");
                printer->Indent();
                printer->Print(_variables, "return _$name$$deprecated$;\n");
                printer->Outdent();
                printer->Print(_variables, "}\n");
                printer->Print(_variables, "inline std::vector<$c_type$>& $domain_skb$::mutable_$name$$deprecated$() {\n");
                printer->Indent();
                printer->Print(_variables, "return _$name$;\n");
                printer->Outdent();
                printer->Print(_variables, "}\n");
    ...
    void PrimitiveFieldSkbGenerator::generate_trans_parse_pb_implementations(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
    ...
    void PrimitiveFieldSkbGenerator::generate_move_ctor_define(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                if (is_atomic) {
    ...
    void PrimitiveFieldSkbGenerator::generate_copy_ctor_define(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                if (is_atomic) {
    ...
    void PrimitiveFieldSkbGenerator::generate_trans_to_pb_implementations(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                if (is_atomic) {
    ...
    std::string PrimitiveFieldSkbGenerator::do_get_default_value(void) const {
    ...
    std::string PrimitiveFieldSkbGenerator::get_default_value() const {
