    ...
    void AnyFieldSkbGenerator::generate_members_inline_implementations(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            ...
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
                ...
                printer->Print(variables_, "inline void $domain_skb$::set_$name$(const std::pair<std::string,std::string> &v) {\n");
                printer->Indent();
            ...
            case google::protobuf::FieldDescriptor::LABEL_REPEATED:
                printer->Print(variables_, "/// setter\n");
                printer->Print(variables_, "inline std::vector<std::pair<std::string,std::string>>& $domain_skb$::mutable_$name$() {\n");
                printer->Indent();
