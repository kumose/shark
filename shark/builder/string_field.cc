...
namespace shark {
    ...
    StringFieldSkbGenerator::
    StringFieldSkbGenerator(const google::protobuf::FieldDescriptor *descriptor )
        : FieldMetaGenerator(descriptor) {
    }

    StringFieldSkbGenerator::~StringFieldSkbGenerator() {
    }

    void StringFieldSkbGenerator::generate_members(google::protobuf::io::Printer *printer) const {
    ...
    void StringFieldSkbGenerator::generate_members_declares(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
    ...
    void StringFieldSkbGenerator::generate_members_inline_implementations(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
    ...
    void StringFieldSkbGenerator::generate_trans_to_pb_implementations(google::protobuf::io::Printer *printer) const {
        switch (descriptor_->label()) {
            case google::protobuf::FieldDescriptor::LABEL_REQUIRED:
            case google::protobuf::FieldDescriptor::LABEL_OPTIONAL:
    ...
    std::string StringFieldSkbGenerator::do_get_default_value(void) const {
        std::string d;
    ...
    std::string StringFieldSkbGenerator::get_default_value(void) const {
        return do_get_default_value();
    }

    void StringFieldSkbGenerator::GenerateStaticInit(google::protobuf::io::Printer *printer) const {

    }

    void StringFieldSkbGenerator::GenerateDescriptorInitializer(google::protobuf::io::Printer *printer) const {
    }
} // namespace shark
