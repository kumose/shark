...
namespace shark {
    ServiceSkbGenerator::ServiceSkbGenerator(const google::protobuf::ServiceDescriptor *descriptor,
    ...
    ServiceSkbGenerator::~ServiceSkbGenerator() {
    }

    // Header stuff.
    void ServiceSkbGenerator::GenerateMainHFile(google::protobuf::io::Printer *printer) {
        GenerateVfuncs(printer);
        GenerateInitMacros(printer);
        GenerateCallersDeclarations(printer);
    }

    void ServiceSkbGenerator::GenerateVfuncs(google::protobuf::io::Printer *printer) {
        printer->Print(vars_,
    ...
    void ServiceSkbGenerator::GenerateInitMacros(google::protobuf::io::Printer *printer) {
        printer->Print(vars_,
    ...
    void ServiceSkbGenerator::GenerateCallersDeclarations(google::protobuf::io::Printer *printer) {
        for (int i = 0; i < descriptor_->method_count(); i++) {
            const google::protobuf::MethodDescriptor *method = descriptor_->method(i);
            std::string lcname = CamelToLower(method->name());
    ...
    void ServiceSkbGenerator::GenerateDescriptorDeclarations(google::protobuf::io::Printer *printer) {
        printer->Print(vars_, "extern const ProtobufCServiceDescriptor $lcfullname$__descriptor;\n");
    }


    // Source file stuff.
    void ServiceSkbGenerator::GenerateCFile(google::protobuf::io::Printer *printer) {
        GenerateServiceDescriptor(printer);
        GenerateCallersImplementations(printer);
        GenerateInit(printer);
    }

    void ServiceSkbGenerator::GenerateInit(google::protobuf::io::Printer *printer) {
        printer->Print(vars_,
                       "void $lcfullname$__init ($cname$_Service *service,\n"
                       "     $lcfullpadd$        $cname$_ServiceDestroy destroy)\n"
                       "{\n"
    ...
    void ServiceSkbGenerator::GenerateServiceDescriptor(google::protobuf::io::Printer *printer) {
    ...
    void ServiceSkbGenerator::GenerateCallersImplementations(google::protobuf::io::Printer *printer) {
        for (int i = 0; i < descriptor_->method_count(); i++) {
            const google::protobuf::MethodDescriptor *method = descriptor_->method(i);
            std::string lcname = CamelToLower(method->name());
            std::string lcfullname = FullNameToLower(descriptor_->full_name(), descriptor_->file());
