...
namespace cppast {
    ...
    using formatting = type_safe::flag_set<FormattingFlags>;

    /// Base class to control the code generation.
    ///
    /// Inherit from it to customize how a [cppast::CppEntity]() is printed
    ...
    public:
        ...
        virtual ~CodeGenerator() noexcept = default;
        ...
        using GenerationOptions = type_safe::flag_set<GenerationFlags>;
        ...
        public:
            ...
            explicit output(type_safe::object_ref<CodeGenerator> gen,
                            type_safe::object_ref<const CppEntity> e,
                            cppast::CppAccessSpecifierKind access)
            ...
            GenerationOptions options(const CppEntity &e, CppAccessSpecifierKind access) const {
            ...
            type_safe::object_ref<CodeGenerator> generator() const noexcept {
                return gen_;
            }
            ...
            const output &operator<<(const BasicCppEntityRef<T, Predicate> &ref) const {
            ...
            const output &excluded(const CppEntity &e) const {
        ...
        private:
            type_safe::object_ref<CodeGenerator> gen_;
            type_safe::object_ref<const CppEntity> e_;
    ...
    protected:
        ...
        const CppEntity &main_entity() const noexcept {
        ...
        bool generate_code(const CppEntity &entity);
    ...
    private:
        ...
        virtual GenerationOptions do_get_options(const CppEntity &e,
                                                  cppast::CppAccessSpecifierKind access) {
            (void) e;
            (void) access;
            return {};
        ...
        virtual void on_begin(const output &out, const CppEntity &e) {
            (void) out;
            (void) e;
        }
        ...
        /// The base class version has no effect.
        virtual void on_end(const output &out, const CppEntity &e) {
            (void) out;
            (void) e;
        }
        ...
        /// The base class version has no effect.
        virtual void on_container_end(const output &out, const CppEntity &e) {
            (void) out;
            (void) e;
        }
        ...
        /// \group write
        virtual bool do_write_reference(type_safe::array_ref<const CppEntityId> id, string_view name) {
            (void) id;
        ...
        virtual void do_write_excluded(const CppEntity &e) {
            (void) e;
        ...
        type_safe::optional_ref<const CppEntity> main_entity_;

        friend bool generate_code(CodeGenerator &generator, const CppEntity &e);
    };
    ...
    bool generate_code(CodeGenerator &generator, const CppEntity &e);
    ...
    namespace detail {
        ...
        void write_token_string(CodeGenerator::output &output, const CppTokenString &tokens);
    } // namespace detail
} // namespace cppast
