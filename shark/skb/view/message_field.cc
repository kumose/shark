...
namespace shark {
    ...
    MessageFieldViewGenerator(const google::protobuf::FieldDescriptor *descriptor)
        ...
        variables_["type"] = relative_message_type(descriptor_->message_type(), descriptor_->containing_type(),"View") ;
        variables_["domain_type"] = message_type(descriptor->message_type(), "View");
    }
    ...
    void MessageFieldViewGenerator::generate_members(google::protobuf::io::Printer *printer) const {
        printer->Print(variables_, "shark::MessageView<$type$> _$name$;\n");
    }
    ...
    void MessageFieldViewGenerator::generate_members_declares(google::protobuf::io::Printer *printer) const {
        printer->Print(variables_, "$deprecated$inline shark::MessageView<$type$> $name$() const;\n");
    }

    void MessageFieldViewGenerator::generate_members_inline_implementations(
        google::protobuf::io::Printer *printer) const {
        printer->Print(variables_, "inline shark::MessageView<$domain_type$> $domain_view$::$name$() const {\n");
        printer->Indent();
