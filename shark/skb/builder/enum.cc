...
namespace shark {
    ...
    void EnumSkbGenerator::GenerateValueInitializer(google::protobuf::io::Printer *printer, int index) {

    }

    void EnumSkbGenerator::GenerateEnumDescriptor(google::protobuf::io::Printer *printer) {
